const messages = [
    ...
    { text: "I have something special messages for you", delay: 5000 },
    ...
    { text: "Finally, puchh rhi hu, do you love me naa? Baad me mood change mt kr lena 🫣", options: ["Yes", "No"], noMoves: true },
...
function playFinalMusic() {
    const finalMusic = new Audio("https://raw.githubusercontent.com/PixelAir/for_you/main/Love-You-Forever-Mashup.mp3");
    finalMusic.play();
}
